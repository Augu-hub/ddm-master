            ...
            $this->insertTree(null, [
                ...
                [
                    ...
                    'children'=>[
                        ...
                        // Organigrammes
                        [
                            'key'=>'param-charts','label'=>'Organigrammes Projet','icon'=>'ti ti-chart-infographic','type'=>'item','sort'=>61,
                            'children'=>[
                        ...
                        // ✅ Référentiels Processus (PARAM → pointe vers process.core)
    ...
    'children'    => [
        ...
        [
            ...
            'children' => [
                ...
                // ✅ Nouvelle entrée : Normes de criticité
                [
        ...
        [
            ...
            'children' => [
                [
                    ...
                    'sort'     => 1,
                    'children' => [
                        ['key'=>'process-eval-criticality-overview','label'=>'Vue d’ensemble','icon'=>'ti ti-list-search','type'=>'item','url'=>'/m/process.core/process/evaluations/criticality','route_name'=>'process.core.process.evaluations.criticality.index','sort'=>1],
                        ['key'=>'process-eval-maturity','label'=>'Maturité','icon'=>'ti ti-chart-bar','type'=>'item','url'=>'/m/process.core/process/evaluations/criticality/maturity','route_name'=>'process.core.process.evaluations.criticality.maturity','sort'=>2],
                        ['key'=>'process-eval-motricity','label'=>'Motricité','icon'=>'ti ti-topology-star','type'=>'item','url'=>'/m/process.core/process/evaluations/criticality/motricity','route_name'=>'process.core.process.evaluations.criticality.motricity','sort'=>3],
                        ['key'=>'process-eval-transversality','label'=>'Transversalité','icon'=>'ti ti-arrows-join-2','type'=>'item','url'=>'/m/process.core/process/evaluations/criticality/transversality','route_name'=>'process.core.process.evaluations.criticality.transversality','sort'=>4],
                        ['key'=>'process-eval-strategic','label'=>'Poids stratégique','icon'=>'ti ti-target-arrow','type'=>'item','url'=>'/m/process.core/process/evaluations/criticality/strategic','route_name'=>'process.core.process.evaluations.criticality.strategic','sort'=>5],
                    ],
                ],
                [
                    'key'=>'process-eval-entry',
                    'label'=>'Saisie des notes',
                    'icon'=>'ti ti-clipboard-check',
                    'type'=>'item',
                    'url'=>'/m/process.core/process/evaluations/entry',
                    'route_name'=>'process.core.process.evaluations.entry.index',
                    'sort'=>2,
                ],
                ['key'=>'process-eval-amdec','label'=>'AMDEC (Défaillances)','icon'=>'ti ti-alert-triangle','type'=>'item','url'=>'/m/process.core/process/evaluations/amdec','route_name'=>'process.core.process.evaluations.amdec.index','sort'=>3],
                ['key'=>'process-eval-raci','label'=>'Matrice RACI','icon'=>'ti ti-users-group','type'=>'item','url'=>'/m/process.core/process/evaluations/raci','route_name'=>'process.core.process.evaluations.raci.index','sort'=>4],
                ['key'=>'process-eval-idea','label'=>'Matrice IDEA','icon'=>'ti ti-bulb','type'=>'item','url'=>'/m/process.core/process/evaluations/idea','route_name'=>'process.core.process.evaluations.idea.index','sort'=>5],
            ],
        ],
        ...
        [
            ...
            'sort'     => 50,
            'children' => [
                ['key'=>'process-reports-list','label'=>'Tableau des processus','icon'=>'ti ti-table','type'=>'item','url'=>'/m/process.core/process/reports/list','route_name'=>'process.core.reports.list','sort'=>1],
                ['key'=>'process-reports-criticality','label'=>'Processus par criticité','icon'=>'ti ti-flame','type'=>'item','url'=>'/m/process.core/process/reports/criticality','route_name'=>'process.core.reports.criticality','sort'=>2],
                ['key'=>'process-reports-maturity','label'=>'Graphiques de maturité','icon'=>'ti ti-chart-bar','type'=>'item','url'=>'/m/process.core/process/reports/maturity','route_name'=>'process.core.reports.maturity','sort'=>3],
                ['key'=>'process-reports-motricity','label'=>'Motricité / Transversalité / PS','icon'=>'ti ti-topology-star','type'=>'item','url'=>'/m/process.core/process/reports/motricity','route_name'=>'process.core.reports.motricity','sort'=>4],
                ['key'=>'process-reports-raci','label'=>'Matrices RACI','icon'=>'ti ti-layout-grid','type'=>'item','url'=>'/m/process.core/process/reports/raci','route_name'=>'process.core.reports.raci','sort'=>5],
                ['key'=>'process-reports-idea','label'=>'Matrices IDEA','icon'=>'ti ti-grid-dots','type'=>'item','url'=>'/m/process.core/process/reports/idea','route_name'=>'process.core.reports.idea','sort'=>6],
            ],
        ],
    ],
],
