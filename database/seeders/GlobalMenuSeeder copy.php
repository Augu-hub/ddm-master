...
return [
    [
        ...
        'children' => [
            ...
            // ============================================================
            // 📋 GESTION DES SESSIONS (NOUVELLE SECTION)
            // ============================================================
            [
                'key' => 'process-eval-sessions',
                'label' => 'Gestion des Sessions',
                'icon' => 'ti ti-list',
                'type' => 'item',
                'sort' => 0,
                'url' => '/process/evaluations/sessions',
                'route_name' => 'process.core.sessions.index',
                'description' => 'Créer, dupliquer, archiver, supprimer les sessions d\'évaluation'
            ],

            // ============================================================
            // 📊 ÉVALUATION CRITICITÉ (Axe principal)
            // ============================================================
            [
                ...
                'children' => [
                    [
                        ...
                        'type' => 'item',
                        'url' => '/process/evaluations/criticality',
            ...
            [
                ...
                'type' => 'item',
                'url' => '/process/evaluations/raci',
                'route_name' => 'process.core.raci.index',
                'sort' => 2
            ],

            // ============================================================
            // ⚠️ AMDEC (Analyse des Défaillances)
            // ============================================================
            [
                ...
                'type' => 'item',
                'url' => '/process/evaluations/amdec',
                'route_name' => 'process.core.evaluations.amdec.index',
                'sort' => 3
            ],

            // ============================================================
            // 💡 IDEA (Identification Développement Évaluation Action)
            // ============================================================
            [
    ...
    [
        ...
        [
         ...
         [
            ...
            'sort'     => 50,
            'children' => [
                ['key'=>'process-reports-list','label'=>'dagramme bpml','icon'=>'ti ti-table','type'=>'item','url'=>'/m/process.core/process/reports/list','route_name'=>'process.core.reports.list','sort'=>1],
                ['key'=>'process-reports-criticality','label'=>'Processus par criticité','icon'=>'ti ti-flame','type'=>'item','url'=>'/m/process.core/process/reports/criticality','route_name'=>'process.core.reports.criticality','sort'=>2],
                   ],
        ],
    ],
