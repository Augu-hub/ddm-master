...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::connection('tenant')->create('activity_idea', function (Blueprint $t) {
            $t->id();
            $t->unsignedBigInteger('activity_id');
            $t->unsignedBigInteger('function_id');
            $t->enum('role', ['I','D','E','A']); // Initiateur/Decisionnaire/Executeur/Approbateur
            $t->timestamps();
    ...
    public function down(): void {
        Schema::connection('tenant')->dropIfExists('activity_idea');
    }
};
