...
class MistralFrequencyCriteriaController extends Controller
{
    ...
    /**
     * POST /m/risk.core/frequency/criteria/mistral/suggest
     *
     * Body JSON :
    ...
    public function suggest(Request $request): JsonResponse
    {
        ...
        // Charge tous les niveaux de fréquence de la config pour contextualiser Mistral
        ...
        if (empty($levels)) {
            return response()->json([
                'message' => 'Aucun niveau de fréquence défini pour cette configuration. Créez d\'abord vos niveaux.',
                'hints'   => [],
            ], 422);
        }
    ...
    {
        $hints = [
            'Précisez le sous-secteur (ex : "hôpital public" plutôt que "santé")',
