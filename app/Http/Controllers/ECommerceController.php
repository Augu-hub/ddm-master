...
class ECommerceController extends Controller
{
    ...
    {
        return Inertia::render('e-commerce/orders/details/index');
    }
    ...
    {
        return Inertia::render('e-commerce/products/add/index');
    }

    public function productsDetails()
    {
        return Inertia::render('e-commerce/products/details/index');
    }
