...
export const menu: MenuType[] = [
  ...
  // PARAM (base DIADDEM)
  {
    ...
    children: [
      { key: 'project',      label: 'Projets',        icon: 'ti ti-folders',             parentKey: 'param', url: '/param/projects/index' },
      { key: 'entity',       label: 'Entités',        icon: 'ti ti-building-community',  parentKey: 'param', url: '/param/entities' },
      { key: 'process',      label: 'MPA',            icon: 'ti ti-sitemap',             parentKey: 'param', url: '/param/process' },
      { key: 'function',     label: 'Fonctions',      icon: 'ti ti-components',          parentKey: 'param', url: '/param/function' },
      { key: 'distribution', label: 'Répartition',    icon: 'ti ti-arrows-shuffle',      parentKey: 'param', url: '/param/distribution' },
