<template>
    <VerticalLayout>
        ...
        <b-row>
            <b-col lg="12">
                <UICard title="Basic Range Slider">
                    <div id="rangeslider_basic"></div>
                </UICard>
            </b-col>

            <b-col lg="12">
                <UICard title="Multi Elements Range">
                    <div id="rangeslider_multielement"></div>
                </UICard>
            </b-col>

            <b-col lg="12">
                <UICard title="Value Range Slider">
                    <div>
            ...
            <b-col lg="12">
                <UICard title="Locking Sliders Together">
            ...
            <b-col lg="4">
                <UICard title="Vertical Range Slider">
...
onMounted(() => {
    ...
    const sliderSecondary = document.getElementById('slider-secondary');
    const sliderSuccess = document.getElementById('slider-success');
    const sliderDanger = document.getElementById('slider-danger');
    const sliderInfo = document.getElementById('slider-info');
    const sliderWarning = document.getElementById('slider-warning');
    ...
    if (sliderSecondary) {
        noUiSlider.create(sliderSecondary, colorOptions);
    }
    if (sliderSuccess) {
    ...
    const connectVertical = document.getElementById('slider-connect-upper');
    const tooltipVertical = document.getElementById('slider-vertical-tooltip');
    const limitVertical = document.getElementById('slider-vertical-limit');
