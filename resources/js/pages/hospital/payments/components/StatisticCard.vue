            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-primary fw-medium fs-20 mb-0">
                        ...
                        <span v-if="item.duration" class="fs-13 text-muted ms-1">/ {{ toSentenceCase(item.duration) }}</span>
                    </p>
                </div>
...
import type { StatisticType } from '@/pages/hospital/payments/components/data';
