<template>
    <VerticalLayout>
        ...
        <b-row class="justify-content-center mt-4">
            <b-col lg="12">
                <b-card no-body class="overflow-hidden">
                    <b-card-header class="terms-bg bg-primary p-4 text-center">
                        <div class="mb-3">
                            <Link href="/" class="logo-light">
                                <span><img :src="logo" alt="logo" height="24" /></span>
                            </Link>
                        </div>
                        <h2 class="fw-semibold text-white">Terms & Conditions</h2>
                    </b-card-header>
                </b-card>
                <b-row>
                    <b-col xl="6" lg="12">
                        <b-card no-body>
                            <b-card-header class="border-bottom">
                                <b-card-title tag="h5" class="fw-semibold text-uppercase mb-0">Agreement T0 Terms :</b-card-title>
                            </b-card-header>
                            <b-card-body>
                                <p>
                                    These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of
                                    an entity you and Space we, concerning your access to and use of the space.com website as well as any other media
                                ...
                                <p class="mb-0">
                                    ...
                                    Service. If you do not agree with all of these Terms of Service, then you are expressly prohibited from using the
                        ...
                        <b-card no-body>
                            <b-card-header class="border-bottom">
                                <b-card-title tag="h5" class="fw-semibold text-uppercase mb-0">Cookies :</b-card-title>
                            </b-card-header>
                            <b-card-body>
                                <p>
                                ...
                                <p class="mb-0">
                                    Our website uses these "cookies" to collection information and to improve aur Service. You have the option to
                        ...
                        <b-card no-body>
                            <b-card-header class="border-bottom">
                                <b-card-title tag="h5" class="fw-semibold text-uppercase mb-0">Contact Information :</b-card-title>
                            </b-card-header>
                            <b-card-body>
                                <p class="fs-5 fw-semibold">If you have any questions about these Terms & Conditions, please contact us at :</p>
                                <ol class="d-flex flex-column gap-1 ps-3">
                                    <li>
                                        <p class="mb-0">
                                            <span class="text-dark fw-semibold">Email : </span> <a href="#!">ocenbycoderthemes@mail.com</a>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="mb-0">
                                            <span class="text-dark fw-semibold">Contact Number : </span> <a href="#!">+001 364-364-000</a>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="mb-0">
                    ...
                    <b-col xl="6" lg="12">
                        <b-card no-body>
                            <b-card-header class="border-bottom">
                                <b-card-title tag="h5" class="fw-semibold text-uppercase mb-0">User Representations :</b-card-title>
                            </b-card-header>
                            <b-card-body>
                                <p class="fs-5 fw-semibold">By using the Site, you represent and warrant that :</p>
                                <ol class="d-flex flex-column gap-1 ps-3">
                                    <li>
                                        <p class="mb-0">All registration information you submit will be true, accurate, current, and complete.</p>
                                    </li>
                                    <li>
                                        <p class="mb-0">
                                    ...
                                    <li>
                                        <p class="mb-0">You have the legal capacity and you agree to comply with these Terms of Service.</p>
                                    </li>
                                    <li>
                        ...
                        <b-card no-body>
                            <b-card-header class="border-bottom">
                                <b-card-title tag="h5" class="fw-semibold text-uppercase mb-0">Information Collection and use : </b-card-title>
                            </b-card-header>
                            <b-card-body>
                                <p class="fs-5 fw-semibold">We may employ third-party companies and individuals due to the following reasons :</p>
                                <ol class="d-flex flex-column gap-1 ps-3">
                                    <li>
                        ...
                        <b-card no-body>
                            <b-card-header class="border-bottom">
                                <b-card-title tag="h5" class="fw-semibold text-uppercase mb-0">Limitation of Liability :</b-card-title>
                            </b-card-header>
                            <b-card-body>
                                <p class="mb-1">
                                    Coderthemes will not be liable for any damages arising from the use or inability to use our website or services.
        ...
        <b-row class="justify-content-end mb-3 text-end">
            <b-col lg="6">
