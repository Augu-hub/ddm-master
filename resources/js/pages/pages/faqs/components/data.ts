...
export const integrationFAQs: FAQType[] = [
    {
    ...
    },
    {
        ...
        answer: 'Yes, you can track user sessions across multiple platforms and devices, but it requires implementing a few strategies and using the right tools to ensure accurate tracking.',
    },
    {
...
export const shippingFAQs: FAQType[] = [
    {
    ...
    },
    {
        ...
        answer: "We will swiftly replace any product damaged during transit. Simply reach out to our support team to inform us of the issue within 48 hours of the product's arrival.",
    },
    {
...
export const returnFAQs: FAQType[] = [
    {
