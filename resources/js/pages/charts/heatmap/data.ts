...
export const basicHeatmapChart: ApexChartType = {
    height: 380,
    type: 'heatmap',
    series: [
        {
...
export const multipleHeatmapChart: ApexChartType = {
    height: 380,
    type: 'heatmap',
    series: [
        {
...
// Heatmap - Color Range
export const colorRangeHeatmapChart: ApexChartType = {
    height: 380,
    type: 'heatmap',
    series: [
        {
...
export const rangeHeatmapChart: ApexChartType = {
    height: 380,
    type: 'heatmap',
    series: [
        {
