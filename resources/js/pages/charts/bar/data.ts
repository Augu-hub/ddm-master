...
// Stacked Bar Chart
export const stackedBarChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
export const fullStackedBarChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
export const negativeBarChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
// Reversed Bar Chart
export const reversedBarChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
// Bar with Image Fill
export const imageFillBarChart: ApexChartType = {
    height: 450,
    type: 'bar',
    series: [
        {
...
export const customDataLabelsBarChart: ApexChartType = {
    height: 450,
    type: 'bar',
    series: [
        {
...
// Patterned Bar Chart
export const patternedBarChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
// Bar with Markers
export const markersBarChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
