...
export const datalabelsChart: ApexChartType = {
    height: 396,
    type: 'bar',
    series: [
        {
...
export const stackedColumnChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
export const fullStackedColumnChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
// Column with Markers
export const markersColumnChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
export const groupLabelColumnChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
    ...
    options: {
        ...
        tooltip: {
            x: {
                formatter: function (val) {
                    return 'Q' + dayjs(val) + ' ' + dayjs(val).format('YYYY');
                },
            },
        },
    },
...
export const rotatedLabelsColumnChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
export const negativeValuesColumnChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
export const distributedColumnChart: ApexChartType = {
    height: 380,
    type: 'bar',
    series: [
        {
...
// Range Column Chart
export const rangeColumnChart: ApexChartType = {
    height: 380,
    type: 'rangeBar',
    series: [
        {
...
const shuffleArray = (array: { y: number; quarters: { x: string; y: number }[] }[]) => {
...
export const yearChartOptions: ApexChartType = {
    height: 400,
    type: 'bar',
    series: [
        {
...
export const quarterChartOptions: ApexChartType = {
    series: [
        {
            data: [],
        },
...
export const dataPointSelectionHandler = (e: any, chart: any, opts: any) => {
...
const updateQuarterChart = (sourceChart: any, destChartIDToUpdate: string) => {
    let series = [];
    const seriesIndex = 0;
    const colors = [];
