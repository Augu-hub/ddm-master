<template>
  <div class="auth-page">
    <Head title="Inscription — DADEM Suite" />
      ...
      <main class="form-pane">
        <div class="form-card">
          <div class="form-header">
            ...
            <h1 class="form-title mb-2">Créer un compte</h1>
            <p class="form-subtitle mb-3">Commencez votre essai gratuit dès aujourd'hui.</p>
          </div>
          ...
          <b-form @submit.prevent="submit" class="mb-3 text-start" novalidate>
            <b-form-group label="Nom complet" label-for="name" class="mb-3">
              <b-input-group>
                <b-input-group-text aria-hidden="true"><i class="ti ti-user"></i></b-input-group-text>
                <b-form-input
                  id="name"
                  type="text"
                  name="name"
              ...
              <small v-if="form.errors.name" class="text-danger d-block mt-1">{{ form.errors.name }}</small>
            </b-form-group>
            ...
            <b-form-group label="Adresse e-mail" label-for="email" class="mb-3">
              <b-input-group>
                ...
                <b-form-input
                  ...
                  placeholder="ex. jean.dupont@dadem.app"
                  autocomplete="email"
                  required
                />
              </b-input-group>
            ...
            <b-form-group label="Mot de passe" label-for="password" class="mb-3">
              <b-input-group>
            ...
            <b-form-group label="Confirmer le mot de passe" label-for="password_confirmation" class="mb-2">
              <b-input-group>
                <b-input-group-text aria-hidden="true"><i class="ti ti-lock-check"></i></b-input-group-text>
                <b-form-input
                ...
                >
                  <i :class="showPasswordConfirm ? 'ti ti-eye-off' : 'ti ti-eye'"></i>
                </b-button>
              </b-input-group>
              <small v-if="form.errors.password_confirmation" class="text-danger d-block mt-1">{{ form.errors.password_confirmation }}</small>
            </b-form-group>

            <div class="mb-3">
              <b-form-checkbox v-model="form.terms" :state="fieldState('terms')">
                J'accepte les <a href="#" class="text-primary">conditions d'utilisation</a>
              </b-form-checkbox>
              <small v-if="form.errors.terms" class="text-danger d-block mt-1">{{ form.errors.terms }}</small>
            </div>
            ...
            <div class="d-grid">
              <b-button variant="primary" type="submit" :disabled="form.processing" class="submit-btn">
                ...
                <i v-else class="ti ti-user-plus me-1"></i> Créer mon compte
              </b-button>
            </div>
          </b-form>
          ...
          <p class="register-link text-center mb-0">
            ...
            <Link :href="route('login')" class="fw-semibold">Se connecter</Link>
          </p>

          <div class="security-info mt-3">
            <span class="badge bg-soft-accent text-accent"><i class="ti ti-lock-check me-1"></i> Essai gratuit 14 jours</span>
            <span class="sep">•</span>
            <span><i class="ti ti-credit-card-off me-1"></i> Sans carte bancaire</span>
          </div>
        </div>
      </main>
    </div>
...
const fieldState = (key: 'name' | 'email' | 'password' | 'password_confirmation' | 'terms') => {
...
.form-card :deep(.form-check-input) {
  border-radius: 5px;
  border: 1.5px solid #e2e8f0;
}

.form-card :deep(.form-check-label) {
  font-size: 0.9rem;
  color: var(--slate-700);
}
