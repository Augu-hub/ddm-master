...
const submitProcess = () => {
  ...
  router.post(route('param.projects.processus.store'), payload, {
    preserveScroll: true,
...
const submitActivity = () => {
  ...
  router.post(route('param.projects.activites.store'), payload, {
    preserveScroll: true,
...
const validateDefaults = () => {
  router.post(route('param.projects.macro.validate'), {}, {
    preserveScroll: true, 
    onSuccess: () => router.reload({ only: ['macros'] })
  })
}
...
const submitEdit = async () => {
  ...
  try {
    ...
    await router.put(route('param.projects.mpa.update', edit.value.id), { name: edit.value.name }, { preserveScroll: true, preserveState: true })
