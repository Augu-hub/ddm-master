  ...
  <VerticalLayout>
    ...
    <b-card class="shadow-sm">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-semibold mb-0"><i class="ti ti-topology-star text-info me-1"></i> Niveaux de motricité</h5>
...
const submit = (item) => {
  ...
  form.post(route('process.core.process.evaluations.criticality.update', 'process_motricity_scales'), {
    preserveScroll: true,
    onSuccess: () => alert('✅ Motricité mise à jour !')
  })
}
</script>
