  ...
  <VerticalLayout>
    ...
    <b-card class="shadow-sm">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-semibold mb-0"><i class="ti ti-chart-bar text-primary me-1"></i> Niveaux de maturité</h5>
...
const submit = (item) => {
  ...
  form.post(route('process.core.process.evaluations.criticality.update', 'process_maturity_levels'), {
    preserveScroll: true,
    onSuccess: () => alert('✅ Maturité mise à jour !')
  })
}
</script>
