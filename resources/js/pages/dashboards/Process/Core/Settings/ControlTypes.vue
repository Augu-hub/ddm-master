<template>
  <VerticalLayout>
    <Head title="Types de contrôles – Référentiels" />

    <b-card>
      <div class="d-flex justify-content-between align-items-center mb-2">
        <h5 class="mb-0"><i class="ti ti-shield-check me-1 text-primary"></i>Types de contrôles (activité)</h5>
        ...
        <b-table-simple hover class="table table-sm table-nowrap">
          ...
          <b-tbody>
            ...
            <b-tr v-if="!items || items.length===0">
              <b-td colspan="2" class="text-center text-muted py-3">Aucun enregistrement</b-td>
            </b-tr>
          </b-tbody>
        </b-table-simple>
      </div>
