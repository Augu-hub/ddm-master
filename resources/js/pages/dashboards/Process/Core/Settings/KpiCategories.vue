<template>
  <VerticalLayout>
    <Head title="KPI – Référentiels" />

    <b-card>
      <div class="d-flex justify-content-between align-items-center mb-2">
        <h5 class="mb-0"><i class="ti ti-graph me-1 text-primary"></i>Catégories KPI</h5>
        ...
        <b-table-simple hover class="table table-sm table-nowrap">
          ...
          <b-tbody>
            <b-tr v-for="it in items" :key="it.id">
              ...
              <b-td>{{ it.label }}</b-td>
              <b-td class="text-center">{{ it.sort }}</b-td>
            </b-tr>
            <b-tr v-if="!items || items.length===0">
              <b-td colspan="3" class="text-center text-muted py-3">Aucun enregistrement</b-td>
            </b-tr>
          </b-tbody>
        </b-table-simple>
      </div>
